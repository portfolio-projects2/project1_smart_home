...
namespace WebServer.Controllers
{
    ...
    public class AutomationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([FromBody] ViewsModel vm)
        {
            ...
            aut.energySourceDevice = energySourceDevice;
            aut.automationTitle = vm.automationTitle;
            aut.active = vm.automationState;
            aut.automationTimeRange = autTimeRange;
            _context.Automation.Add(aut);
